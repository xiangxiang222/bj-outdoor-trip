...
const cancelPolicy = {
  title: "退改说明",
  summary: "按距出发日比例退费：10 天前退 100%，3 天前退 80%，不足 3 天退 50%；正式开团后不退费。",
  items: [
    "出发前 10 天及以上：退 100%。",
    "出发前 3 天及以上：退 80%。",
    "出发前不足 3 天（含出发当天未正式开团）：退 50%。",
    "正式开团后：不退费，不可自行取消。",
...
const faqs = [
  ...
  {
    q: "官方团和个人团有什么区别？",
    a: "上架线路会按天自动开官方团。个人发团过审后自己招人，成团奖励 200 元。出行前一天，同一线路、同一集合时间和地点还没成团的，会并入官方团；人多了官方团自动换更大车。并入后会发短信，绑了微信的还会发小程序通知。转发报名链接或海报二维码，好友报名成功后你拿团费 5%。",
  },
  {
    q: "想把一条线收录进来怎么办？",
    a: "在「我的」申请收录线路，留下手机和微信。客服微信是「同行者众」。审核通过后，该线首次成团奖励 300 元。发团仍走首页「发团」，和收录不是同一件事。",
  },
  {
    q: "怎么把团发到抖音？",
    a: "行程页点「分享报名」，复制抖音文案并保存海报，打开抖音发作品时粘贴。好友从链接或二维码报名，成团后你拿团费 5%。线路实拍也可把抖音 / TikTok 分享链接贴到发团或后台的视频栏。",
  },
];
...
const officialAccounts = [
  ...
  { platform: "小红书", name: "同行者众户外", id: "@同行者众", remark: "目的地攻略与成团日记" },
  {
    ...
    name: "同行者众户外",
    id: "@同行者众",
    url: "https://www.douyin.com/search/%E5%90%8C%E8%A1%8C%E8%80%85%E4%BC%97%E6%88%B7%E5%A4%96",
    remark: "短视频看路况与风景",
  },
  ...
  sections: [
    {
      ...
      items: [
        ...
        "一个团一位摄影师。还没有时可在行程页点「报名摄影师」，免个人团费（保险另计）。",
        "人数不足或天气封山时，发起人可解散；已付款按付款人原路退回。",
      ],
    },
    {
      title: "报名与座位",
