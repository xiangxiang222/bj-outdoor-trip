...
const faqs = [
  ...
  {
    q: "官方团和个人团有什么区别？",
    a: "上架线路会按天自动开官方团。个人发团过审后自己招人。出行前一天，同一线路、同一集合时间和地点还没成团的，会并入官方团；人多了官方团自动换更大车。并入后会发短信，绑了微信的还会发小程序通知。",
  },
  {
    q: "想把一条线收录进来怎么办？",
    a: "在「我的」申请收录线路，留下手机和微信。客服微信是「同行者众」。审核通过后会出现在线路目录。发团仍走首页「发团」，和收录不是同一件事。",
  },
];
...
const leaderRecruitCopy = "已通过领队申请的用户，可以在行程页的空位上报名带队。";
