  ...
  it("user publish waits for review and then appears", async () => {
    ...
    const created = await agent
      ...
      .send({
        ...
        offerType: "early",
        minGroupSize: 4,
        videos: ["https://www.bilibili.com/video/BV1GJ411x7h7", "https://www.douyin.com/video/7123456789012345678"],
      })
      .expect(200);
    ...
    assert.equal(created.body.data.route.videos[1].provider, "douyin");
    assert.equal(created.body.data.route.videos[1].videoId, "7123456789012345678");
