...
const routes = [
  { path: "/", redirect: "/m" },
  {
    ...
    children: [
      ...
      { path: "settings/font", name: "look-font", component: () => import("@/views/mobile/LookFont.vue") },
      { path: "settings/night", name: "look-night", component: () => import("@/views/mobile/LookNight.vue") },
      { path: "settings/lang", name: "look-lang", component: () => import("@/views/mobile/LookLang.vue") },
      ...
      { path: "notices", name: "notices", component: () => import("@/views/mobile/Notices.vue") },
      { path: "views", name: "views", component: () => import("@/views/mobile/Views.vue") },
      { path: "companions", name: "companions", component: () => import("@/views/mobile/Companions.vue") },
      { path: "follows", name: "follows", component: () => import("@/views/mobile/Follows.vue") },
