<template>
  <div>
    ...
    <p class="muted">公开限量领取。库存在领取时扣减；报名成功才核销。与会员 95 折取更低，不叠加。公司团不可用。</p>
...
function open() {
  ...
  form.value = { scheduleId: preset, kind: "amount", value: 30, fold: 8, capAmount: 50, total: 20, floorPrice: 0, name: "" };
