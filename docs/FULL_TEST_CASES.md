...
**M-09 校园认证空表**  
身份默认「在读师生」，学校、学院、专业可从北京高校名单里选（可空；学院挂在学校下，专业挂在学院下），在读须学号和学生证照片。
...
`activityKind` 4、`auth` 3、`chinaAreas` 6、`couponTime` 3、`feedCard` 3、`feedList` 6、`idcard` 4、`labels` 4、`media` 3、`offer` 2、`pageChrome` 2、`phone` 2、`pulse` 1、`routeMeta` 6、`scanFacts` 5、`share` 4、`staff` 3、`story` 2、`trips` 4、`weatherChart` 2、`wechatPay` 2。
